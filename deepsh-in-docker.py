...
program_description = """Build and run Deepsh in a fresh, controlled
...
parser.add_argument("--command", "-c", default="deepsh", metavar="command")
...
print("Building and running Deepsh")
...
subprocess.call(["docker", "build", "-t", "deepsh", "."])
