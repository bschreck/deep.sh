"""Tools for diff'ing two deepsh history files in a meaningful fashion."""

import datetime
import difflib
import itertools

from deepsh.color_tools import COLORS
...
class HistoryDiffer:
    """This class helps diff two deepsh history files."""
