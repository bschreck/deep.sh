"""Directory stack and associated utilities for the deepsh shell.
...
from deepsh.tools import get_sep
...
def _try_cdpath(apath):
    ...
    # CDPATH=$HOME/src (with src/deepsh/ inside)
    # $ cd deepsh -> src/deepsh (with deepsh/deepsh)
    # a second $ cd deepsh has no effects, to move in the nested deepsh
    # in bash a full $ cd ./deepsh is needed.
    # In deepsh a relative folder is always preferred.
    env = XSH.env
