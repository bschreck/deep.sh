...
from deepsh.commands_cache import executables_in
...
from deepsh.lib.modules import ModuleFinder
...
class CommandCompleter:
    ...
    def __call__(self, full_ctx: CompletionContext):
        ...
        if hasattr(module, "deepsh_complete"):
            func = module.deepsh_complete
            return func(ctx)
