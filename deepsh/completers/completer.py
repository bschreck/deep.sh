...
from deepsh.cli_utils import Annotated, Arg, NumpyDoc
from deepsh.completers.tools import RichCompletion, is_exclusive_completer, justify
...
def remove_completer(
    ...
    """Removes a completer from deepsh
