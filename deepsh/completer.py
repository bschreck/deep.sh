...
from deepsh.parsers.completion_context import CompletionContext, CompletionContextParser
from deepsh.tools import print_exception


class Completer:
    """This provides a list of optional completions for the deepsh shell."""
    ...
    def complete_from_context(self, completion_context, old_completer_args=None):
        trace = XSH.env.get("DEEPSH_TRACE_COMPLETIONS")
        if trace:
