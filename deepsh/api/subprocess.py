"""Deepsh extension of the standard library subprocess module, using deepsh for
subprocess calls"""

from deepsh.api.os import indir
from deepsh.built_ins import XSH, subproc_captured_hiddenobject, subproc_captured_stdout
