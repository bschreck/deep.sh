...
# Copyright 2015-2016, the deepsh developers. All rights reserved.
import builtins
...
def load_module_in_background(
    ...
    env : Mapping or None, optional
        Environment this will default to __deepsh__.env, if available, and
    ...
    if env is None:
        deepsh_obj = getattr(builtins, "__deepsh__", None)
        env = os.environ if deepsh_obj is None else getattr(deepsh_obj, "env", os.environ)
