...
Examples
 please see :py:class:`deepsh.completers.completer.CompleterAlias` class
"""
...
def get_argparse_formatter_class():
    ...
    if (
        ...
        and XSH.env.get("DEEPSH_INTERACTIVE")
        and HAS_PYGMENTS
    ):
...
class ArgParserAlias:
    ...
    Examples
    ---------
        For usage please check :py:mod:`deepsh.completers.completer`
    """
    ...
    def deepsh_complete(self, command, **kwargs):
