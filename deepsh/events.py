...
In all likelihood, you want deepsh.built_ins.XSH.events
...
def debug_level():
    if XSH.env:
        return XSH.env.get("DEEPSH_DEBUG")
...
class EventManager:
    ...
    def _mkevent(name, species=Event, doc=None):
        # NOTE: Also used in `deepsh_events` test fixture
