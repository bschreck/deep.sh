"""Implements the deepsh parser for Python v3.8."""

import deepsh.parsers.ast as ast
from deepsh.parsers.base import store_ctx
from deepsh.parsers.v36 import Parser as ThreeSixParser


class Parser(ThreeSixParser):
    """A Python v3.8 compliant parser for the deepsh language."""
