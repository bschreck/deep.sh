"""Implements the deepsh parser for Python v3.6."""

import deepsh.parsers.ast as ast
from deepsh.parsers.base import BaseParser, lopen_loc, store_ctx


class Parser(BaseParser):
    """A Python v3.6 compliant parser for the deepsh language."""
