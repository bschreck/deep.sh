"""Tokenization help for deepsh programs.
...
It is modified to properly tokenize deepsh code, including backtick regex
path and several deepsh-specific operators.
...
_glbs = globals()
for v in _deepsh_tokens.values():
    _glbs[v] = N_TOKENS
    tok_name[N_TOKENS] = v
    N_TOKENS += 1
    __all__.append(v)
...
EXACT_TOKEN_TYPES.update(_deepsh_tokens)
    ...
    while True:  # loop over lines in stream
        ...
        while pos < max:
            ...
            if pseudomatch:  # scan for tokens
                ...
                # Deepsh-specific Regex Globbing
