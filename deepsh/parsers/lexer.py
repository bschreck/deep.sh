...
from deepsh.parsers.ply.lex import LexToken
from deepsh.parsers.tokenize import (
    CASE,
    COMMENT,
    DEDENT,
    DOLLARNAME,
...
def get_tokens(s, tolerant, pymode=True, tokenize_ioredirects=True):
    """
    Given a string containing deepsh code, generates a stream of relevant PLY
...
class Lexer:
    """Implements a lexer for the deepsh language."""
