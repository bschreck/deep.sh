...
os.environ["DEEPSH_NO_AMALGAMATE"] = "1"

from deepsh import __version__ as DEEPSH_VERSION
from deepsh.environ import Env, Var, Xettings

if tp.TYPE_CHECKING:
    from deepsh.environ import VarKeyType
import deepsh.main as xmain
...
if spec is not None:
    ...
    from deepsh.shells.ptk_shell import events
else:
...
version = DEEPSH_VERSION.rsplit(".", 1)[0]

# The full version, including alpha/beta/rc tags.
release = DEEPSH_VERSION
...
if not on_rtd:
    ...
    html_theme_options = {
        "source_repository": "https://github.com/deepsh/deepsh/",
        "source_branch": "main",
...
latex_documents = [
    ("index", "deepsh.tex", "deepsh documentation", "Anthony Scopatz", "manual")
]
...
# runthis
runthis_server = "https://runthis.deepsh.org:80"
...
def setup(app: Sphinx):
    from deepsh.pyghooks import DeepshConsoleLexer

    app.add_lexer("deepshcon", DeepshConsoleLexer)
